	...
	factory: (require) => {
		...
		function WorkbenchPluginCard() {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, react_jsx_runtime.jsxs)("div", {
						className: "mxCardHead",
						children: [
							(0, react_jsx_runtime.jsx)("div", {
								className: "mxCardTitle",
								children: "毛毛星内容工作台"
							}),
							(0, react_jsx_runtime.jsx)("div", {
								className: "mxCardDesc",
								children: "Maomao Creator Workbench 插件配置：环境状态、内容目录、系列、平台与内容规则。"
							})
						]
					}),
					(0, react_jsx_runtime.jsxs)("div", {
