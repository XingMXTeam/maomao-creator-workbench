window.__ModuleLoader__.load({
	...
	factory: (require) => {
		 ...
		 * Layout per product spec: 环境状态 / 影片目录 / 启用平台 / 脚本规则 / 接口密钥. */
		function WorkbenchPluginCard() {
			...
			(0, react.useEffect)(() => {
				...
				const update = () => {
					...
					setSettings(snap);
					setVideoDirDraft((prev) => prev === "" ? (typeof snap.videoDir === "string" ? snap.videoDir : "") : prev);
					setScriptRulesDraft((prev) => prev === "" ? (typeof snap.scriptRules === "string" ? snap.scriptRules : "") : prev);
				};
				update();
			...
			const envRow = (label) => (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("div", {
						className: "mxPcRowLabel",
						children: label
					}),
					(0, react_jsx_runtime.jsx)("div", {
						className: "mxPcRowValue",
						children: "可用"
					})
				]
			}, label);
			const keyRow = (label, field) => {
				const saved = typeof settings?.[field] === "string" ? settings[field] : "";
						...
						children: [
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									(0, react_jsx_runtime.jsx)("div", {
										className: "mxPcDesc",
										children: "环境状态、影片目录、启用平台、脚本规则与接口密钥。"
									})
								]
							}),
						...
						children: [
							...
							group("影片目录", (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									(0, react_jsx_runtime.jsx)("input", {
										...
										onBlur: (e) => {
											const value = e.target.value.trim();
											if (value !== (settings?.videoDir ?? "")) saveField("videoDir", value);
										}
									}),
									(0, react_jsx_runtime.jsx)("button", {
										type: "button",
							...
							group("脚本规则", (0, react_jsx_runtime.jsx)("textarea", {
								...
								onBlur: (e) => {
									...
									if (value !== (settings?.scriptRules ?? "")) saveField("scriptRules", value);
								}
							})),
