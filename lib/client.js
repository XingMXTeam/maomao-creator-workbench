window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function SidebarWorkbenchAction({ wide }) {
			...
			return (0, react_jsx_runtime.jsx)("button", {
				...
				style: {
					...
					background: open ? "var(--dsw-alias-interactive-bg-hover)" : "var(--dsw-specific-input-major)",
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: (0, react_jsx_runtime.jsx)(ContentManagerWorkspace, {})
					})
				]
			});
		}
		...
		function apply(ctx) {
			...
			window.__maomaoCloseWorkbench = () => overlayStore.set(false);

			// 左侧侧边栏入口（footer 是官方唯一的 additive sidebar slot）。
