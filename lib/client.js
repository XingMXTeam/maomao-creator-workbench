window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		// conversation.view (workbench tab) · settings.plugins.tab (settings card
		// inside 设置 → 插件) · sidebar.footer.action · shell.overlay
		...
		/** Settings card page (settings.plugins.tab entry, inside 设置 → 插件). */
		...
		function apply(ctx) {
			...
			// Settings card lives INSIDE 设置 → 插件 as a sub-tab
			// (settings.plugins.tab), not as a top-level settings page.
