window.__ModuleLoader__.load({
	...
	factory: (require) => {
		 ...
		 * Styled like the harness's own plugin cards (expandable header + body). */
						...
						children: [
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									(0, react_jsx_runtime.jsx)("div", {
										className: "mxPcDesc",
										children: "Maomao Creator Workbench — 环境状态、内容目录、系列、平台与内容规则。"
									})
								]
							}),
